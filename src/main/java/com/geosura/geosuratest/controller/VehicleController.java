...
import com.geosura.geosuratest.exception.ResourceNotFoundException;
import com.geosura.geosuratest.model.Vehicle;

import com.geosura.geosuratest.repository.VehicleRepository;
...
public class VehicleController {
    ...
    public ResponseEntity<Vehicle> updateVehicle(@PathVariable(value = "id") Long vehicleId,
    	...
    	vehicle.setLicencePlate(vehicleDetails.getLicencePlate());
